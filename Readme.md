...
If you check the API (http://IP_OF_YOUR_CLUSTER:8080/api) you can see the actor hierarchy (/tree), the global status (/status) and a report of the tasks (/reporting). Via /upload you can also upload new task jar filed.

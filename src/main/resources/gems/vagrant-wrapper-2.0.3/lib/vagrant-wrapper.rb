...
class VagrantWrapper
  ...
  def require_version(version)
    ...
    raise de.oth.de.oth.clustering.java.clustering.scala.Exceptions::NotInstalled, "Vagrant is not installed." if vagrant_ver.nil?
    unless version_req.satisfied_by?(Gem::Version.new(vagrant_ver))
      raise de.oth.de.oth.clustering.java.clustering.scala.Exceptions::Version, "Vagrant #{version} is required. You have #{vagrant_ver}."
    end
  end
  ...
  def self.require_or_help_install(version)
    ...
    rescue de.oth.de.oth.clustering.java.clustering.scala.Exceptions::Version => e
